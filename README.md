...
---
# ✅ Project 1: Full-Stack To-Do List

Бұл жоба FastAPI (backend) және Next.js (frontend) көмегімен жасалған.

## Жасаған өзгерістер

- "Барлығын өшіру" батырмасы қосылды
- Толық қосу/өшіру/белгілеу логикасы өңделді
- Дизайн Tailwind көмегімен жақсартылды

## Қосқан: [Жолдас Жандарбек]
